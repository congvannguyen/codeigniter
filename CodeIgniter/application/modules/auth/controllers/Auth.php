...
class Auth extends MX_Controller {
    ...
    function index() {
        ...
        if (!$this->ion_auth->logged_in()) {
            ...
            echo Modules::run('client');
            //return show_error('You must be an administrator to view this page.');
        } else {
            // set the flash data error message if there is one
            $this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');

            $totalUsers = $this->ion_auth->count();
            $perpage = 2;
            ...
            $config['num_links'] = 2;
            $config['full_tag_open'] = '<ul class="pagination pagination-lg"><li>';
            $config['full_tag_close'] = '</li></ul>';
            $config['cur_tag_open'] = '<a>';
            $congig['cur_tag_close'] = '</a>';
            $config['base_url'] = base_url() . 'users';
            $congig['uri_segment'] = 2;
            ...
            $this->data['users'] = $this->ion_auth->getRange($perpage, $offset);
            ...
            $this->_render_page('admin/main', $this->data);
        }
    }
    ...
    public function translate($language = '') {
        ...
        $this->session->set_userdata('site_lang', $languages);
        redirect('auth');
    }
